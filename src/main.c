...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        set_instance_uniform(14, floors);
        ...
        set_instance_uniform(14, Xwalls);
        glBindTexture(GL_TEXTURE_2D, walltex);
        glDrawArraysInstanced(GL_TRIANGLES, 0, 6, 14);

        /* draw all Z walls */
        shader_uniforms(&proj, view, &Zwallmodel);
        set_instance_uniform(13, Zwalls);
        glDrawArraysInstanced(GL_TRIANGLES, 0, 6, 13);
